...
**Time and Locations**<br>Tuesday/Thursday, 8am -- 9:15am, IRB 0318<br>

**Instructor**<br>
[Laxman Dhulipala](https://www.cs.umd.edu/~laxman/) (IRB 5150); Office hours TBD

**Teaching Assistants**

[Kishen Gowda](https://www.cs.umd.edu/people/kishen19). Office hours: TBD<br>
Sam Lee. Office hours: TBD <br>
...
[here](https://docs.google.com/spreadsheets/d/1MCH8uTbHHIoHdhuHDTB81uFQUtIAJM9JsSxdwA3KRW0),
and also find this information above.
...
* Please join [Piazza](https://piazza.com/umd/fall2024/cmsc451section101) and [Gradescope](https://www.gradescope.com/courses/589298) (code: J77WPY).
...
| Date | Topic 
|-------|--------|--------|------ |
| Aug 27 (Tu) | Introduction and Basics (Correctness, Efficiency Analysis) **[HW1 Out]**
| Aug 39 (Th) | Computational Models and Lower Bounds
| Sep 03 (Tu) | Amortized Analysis 
| Sep 05 (Th) | Amortization and Hashing
| Sep 10 (Tu) | Perfect Hashing
| Sep 12 (Th) | Streaming (Count-Min Sketch) **[HW1 Due, Hw2 Out]**
| Sep 17 (Tu) | Graphs 1: BFS and DFS 
...
| Oct 03 (Th) | Dynamic Programming 1: Weighted Interval Scheduling, OBST  **[HW2 Due, HW3 Out]**
| Oct 08 (Tu) | Dynamic Programming 2: Knapsack, LIS, Sequence Alignment
| Oct 10 (Th) | **Midterm**
| Oct 15 (Tu) | Flows 1: Ford-Fulkerson
| Oct 17 (Th) | Flows 2: Max-Flow Min-Cut Theorem 
| Oct 22 (Tu) | Flows 3: Shortest Augmenting Paths
| Oct 24 (Th) | Flows 4: Blocking Flows (Dinic's)  **[HW3 Due, HW4 Out]**
| Oct 29 (Tu) | LP 1: LP Basics 
...
| Nov 14 (Th) | Approximation 1: Classic Examples **[HW4 Due, HW5 Out]**
| Nov 19 (Tu) | Approximation 2: Primal Dual
| Nov 21 (Th) | Online Algorithms
| Nov 26 (Tu) | Randomized Global Min Cut  
| *Thanksgiving break* |
| Dec 03 (Tu) | Parallelism
